...
# API Guidance
API's should be lightweight.  If the API contains a significant amount of business logic, the API likely needs to be decomposed into smaller APIs ([service normalization pattern](https://en.wikipedia.org/wiki/Service_normalization_pattern))
